    ...
    >
      <div className="grid min-h-[calc(100dvh-10rem)] items-center gap-10 lg:grid-cols-[0.72fr_1.28fr]">
        <div className="max-w-xl">
          <p className="map-copy text-xs font-semibold text-neutral-500">
            Location lock
          </p>
          <h2 className="map-copy mt-4 font-sans text-base font-semibold text-white">
        ...
        >
          <div className="map-grid absolute inset-0 bg-[linear-gradient(rgba(241,241,241,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(241,241,241,0.08)_1px,transparent_1px)] bg-[size:44px_44px]" />
          {MATRIX_STREAMS.map((stream) => (
            <div
              key={stream.left}
              data-delay={stream.delay}
              className="map-stream pointer-events-none absolute top-0 z-10 flex flex-col gap-1 font-sans text-[0.62rem] font-semibold leading-none text-white/45"
          ...
          <div className="map-scan-line absolute left-0 top-[28%] z-20 h-px w-full bg-white/70 shadow-[0_0_18px_rgba(241,241,241,0.8)]" />
          <div className="map-scan-line absolute left-0 top-[54%] z-20 h-px w-full bg-white/50 shadow-[0_0_18px_rgba(241,241,241,0.65)]" />
          <div className="map-scan-line absolute left-0 top-[72%] z-20 h-px w-full bg-white/40 shadow-[0_0_18px_rgba(241,241,241,0.55)]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_58%_45%,rgba(241,241,241,0.2),transparent_12%),radial-gradient(circle_at_48%_55%,rgba(241,241,241,0.1),transparent_22%),linear-gradient(135deg,transparent_0_45%,rgba(241,241,241,0.08)_45%_46%,transparent_46%_100%)]" />
          ...
          <div className="map-data-bit absolute left-5 top-5 z-20 rounded-full border border-white/10 bg-black/50 px-3 py-1 text-[0.62rem] font-semibold text-neutral-400 backdrop-blur">
            Constructing route
          </div>
          <div className="map-data-bit absolute right-5 top-5 z-20 rounded-full border border-white/10 bg-black/50 px-3 py-1 text-[0.62rem] font-semibold text-neutral-400 backdrop-blur">
            Coordinates locked
          </div>
          ...
          <div className="map-marker absolute left-[58%] top-[45%] flex -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-3">
            <span className="h-4 w-4 rounded-full bg-white shadow-[0_0_32px_rgba(241,241,241,0.9)]" />
            <span className="rounded-full border border-white/20 bg-black/70 px-4 py-2 text-xs font-semibold text-white backdrop-blur">
              Moxy Kinshicho
            </span>
          </div>
          <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between border-t border-white/10 pt-4 text-xs text-neutral-500">
            <span>Tokyo JP</span>

...
export function LanguageToggle({ className = "", variant = "dark" }: Props) {
  ...
  const indicatorClassName = onFooter
    ? "pointer-events-none absolute top-0.5 bottom-0.5 left-0.5 w-[calc((100%-4px)/2)] rounded-full bg-white transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]"

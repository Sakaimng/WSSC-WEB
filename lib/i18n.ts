...
export const i18n = {
  en: {
    ...
    merch: {
      eyebrow: "New release",
      title: "WSSC MCGA Cap",
      subtitle: "The first WSSC cap.",
      price: "¥3,980",
      taxIncluded: "Tax included",
      description:
        "A black six-panel cap with MAKE COMEDY GREAT AGAIN embroidered on the front and WHY SO SERIOUS COMEDY embroidered on the back.",
      colorLabel: "Color",
      colorValue: "Black",
      sizeLabel: "Size",
      sizeValue: "One size",
      cta: "Order the cap",
      contactNote: "Secure checkout powered by Square.",
      detailsTitle: "Product details",
      details: [
        "Classic six-panel baseball cap shape",
        "Ventilation eyelets embroidered on top",
        "Adjustable strap at the back",
        "Front and back embroidery",
      ],
      galleryLabel: "Product gallery",
      imageAlt: "WSSC Make Comedy Great Again black cap",
      previousImage: "Previous product image",
      nextImage: "Next product image",
      showImage: "Show product image",
      popupEyebrow: "WSSC merch / new release",
      popupTitle: "WSSC MCGA CAP",
      popupPrice: "¥3,980",
  ...
  jp: {
    ...
    merch: {
      eyebrow: "新作",
      title: "WSSC MCGA Cap",
      subtitle: "WSSC初のオリジナルキャップ。",
      price: "¥3,980",
      taxIncluded: "税込",
      description:
        "ブラックの6パネルキャップ。フロントに「MAKE COMEDY GREAT AGAIN」、バックに「WHY SO SERIOUS COMEDY」を刺繍。",
      colorLabel: "カラー",
      colorValue: "ブラック",
      sizeLabel: "サイズ",
      sizeValue: "ワンサイズ",
      cta: "キャップを注文する",
      contactNote: "Squareの安全な決済ページへ移動します。",
      detailsTitle: "商品詳細",
      details: [
        "クラシックな6パネルキャップ",
        "トップに刺繍アイレット",
      ...
      galleryLabel: "商品ギャラリー",
      imageAlt: "WSSC Make Comedy Great Again ブラックキャップ",
      previousImage: "前の商品画像",
      nextImage: "次の商品画像",
      showImage: "商品画像を表示",
      popupEyebrow: "WSSCグッズ / 新作",
      popupTitle: "WSSC MCGA CAP",
      popupPrice: "¥3,980",
      popupBody: "税込。発売中。",
      popupCta: "キャップを見る",
